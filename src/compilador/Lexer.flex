...
not  |
and |
or  { return token(yytext(), "PALABRA_RESERVADA", yyline, yycolumn); }
...
/* Repetir */
program|
repetirMientras { return token(yytext(), "PROGRAM", yyline, yycolumn); }
...
/* Estructura si */
if     |
sino { return token(yytext(), "IF", yyline, yycolumn); }
/* Estructura then */
