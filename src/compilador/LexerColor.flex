...
not  |
and |
or  {return textColor(yychar, yylength(), new Color(148, 58, 173));}
...
/* Estructura then */
then { return textColor(yychar, yylength(), new Color(48, 63, 159)); }

/* Estructura until */
until  { return textColor(yychar, yylength(), new Color(121, 107, 255)); }
/* Estructura while */
